...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.notice_create.setGeometry(QRect(540, 280, 101, 31))
        self.open_notice_dir = QPushButton(Form)
        self.open_notice_dir.setObjectName(u"open_notice_dir")
        self.open_notice_dir.setGeometry(QRect(540, 330, 101, 31))
        ...
        self.line.setGeometry(QRect(30, 370, 691, 16))
        self.line.setFrameShape(QFrame.HLine)
        self.line.setFrameShadow(QFrame.Sunken)
        self.note_text = QLabel(Form)
        self.note_text.setObjectName(u"note_text")
        self.note_text.setGeometry(QRect(50, 390, 631, 211))
